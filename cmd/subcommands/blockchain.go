...
`,
	...
	cmdBlockchain := &cobra.Command{
		Use:   "blockchain",
		Short: "Interact with the Zippy.one Blockchain",
		Long: `
Query Zippy's blockchain for completed transaction, historic records
`,
		RunE: func(cmd *cobra.Command, args []string) error {
			cmd.Help()
			return nil
...
`,
	...
	subCommands := []*cobra.Command{{
		...
		Short: "The version of the Zippy Protocol",
		Long: `
Query Zippy's blockchain for high level metrics, queries
`,
		RunE: func(cmd *cobra.Command, args []string) error {
