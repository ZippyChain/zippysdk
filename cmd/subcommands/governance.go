...
import (
	...
	"github.com/ZippyChain/zippysdk/pkg/governance"
...
func init() {
	cmdGovernance := &cobra.Command{
		Use:   "governance",
		Short: "Interact with the Zippy spaces on https://snapshot.org",
		Long: `
Support interaction with the Zippy governance space on Snapshot, especially for validators that do not want to import their account private key into either metamask or onewallet.
`,
