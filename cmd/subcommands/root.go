...
import (
	...
	rpcV1 "github.com/ZippyChain/zippysdk/pkg/rpc/v1"
...
var (
	...
	RootCmd = &cobra.Command{
		...
		Long: fmt.Sprintf(`
CLI interface to the Zippy blockchain

%s`, g("Invoke 'zpy cookbook' for examples of the most common, important usages")),
...
var (
	...
	VersionWrapDump = ""
	cookbook        = color.GreenString("zpy cookbook")
