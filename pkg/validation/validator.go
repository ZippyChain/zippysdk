...
var (
	addressValidationRegexp = regexp.MustCompile(`^(zpt[a-zA-Z0-9]{39})|(0x[a-fA-F0-9]{40})`)
)

// ValidateAddress validates that an address is a valid bech32 address (zpt...) or a valid base16 address (0x...)
